...
output_hits_lim_res <- rownames(output_hits_lim[which(output_hits_lim$P.Value < 0.01), ])
...
# We extract the rownames of our significant genes. The 0.05 threshold used.
output_hits_qlf_res <- rownames(qlf.covid_vs_healthy_hits$table[
  which(qlf.covid_vs_healthy_hits$table$FDR < 0.05), ])
